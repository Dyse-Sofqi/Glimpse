...
/** 解析 getSongInfo.php 响应；VIP 歌曲 url 为空视为不可下载 */
...
// --- 在线歌词：lyrics.kugou.com search + download（免登录） ---
...
// --- 推荐歌单：m.kugou.com 移动端 plist 歌单（免登录） ---
...
/** 解析 plist/index 响应：`plist.list.info[]`：specialid/specialname/imgurl/playcount/songcount */
...
/** 解析 plist/list 响应：`list.list.info[]`：hash/filename("歌名 - 歌手")/duration/privilege + filesize */
